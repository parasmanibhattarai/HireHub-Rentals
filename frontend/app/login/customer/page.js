        ...
        >
          ...
          <div className="flex flex-col items-center text-center mb-6">
            ...
            <p className="text-gray-600 text-sm">
              {isLogin ? 'Welcome back! Enter your details to continue' : 'Create your account to start hiring equipment'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {!isLogin && (
              <div className="space-y-1.5">
                <label htmlFor="name" className="text-gray-700 text-sm block">Full Name</label>
